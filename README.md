...
[godoc]: https://godoc.org/github.com/craiggwilson/wire
...
```shell
go install github.com/craiggwilson/wire/cmd/wire@lazy
```
...
For questions, please use [GitHub Discussions](https://github.com/craiggwilson/wire/discussions).
