...
[guide]:     https://github.com/craiggwilson/wire/blob/master/docs/guide.md
...
``` shell
go install github.com/craiggwilson/wire/cmd/wire@latest
```
...
$GOPATH/src/github.com/craiggwilson/wire/_tutorial/wire.go:24:1:
inject InitializeEvent: no provider found for github.com/craiggwilson/wire/_tutorial.Greeter
(required by provider of github.com/craiggwilson/wire/_tutorial.Event)
...
[advanced]:   https://github.com/craiggwilson/wire/blob/master/docs/guide.md#advanced-features
[cleanup]:    https://github.com/craiggwilson/wire/blob/master/docs/guide.md#cleanup-functions
[interfaces]: https://github.com/craiggwilson/wire/blob/master/docs/guide.md#binding-interfaces
[sets]:       https://github.com/craiggwilson/wire/blob/master/docs/guide.md#defining-providers
[values]:     https://github.com/craiggwilson/wire/blob/master/docs/guide.md#binding-values
